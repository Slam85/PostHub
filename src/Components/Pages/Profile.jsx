...
function Profile() {
  ...
  // ON AFFICHE SUR LA PAGE LES ÉLÉMENTS NÉCESSAIRES À L'UTILISATEUR POUR AFFICHER SON PROFIL, LE BOUTON DE MODIFICATION DE SON PROFIL, ET LA PAGE D'ÉDITION DE SON PROFIL
  return (
    <div>
      <NavBar />
      <div className="home">
